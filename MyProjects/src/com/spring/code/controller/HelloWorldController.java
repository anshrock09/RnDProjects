...
public class HelloWorldController {
	...
	public String printHelloMessage(ModelMap map, @PathVariable("firstName") String name){
		...
		map.addAttribute("message","This is the message from HelloWorldController.<br/>The string parameter in UPPERCASE is "+helloWorldServic.convertToUpperCase(name)+""
				+ "<br/>The string parameter in LOWERCASE is "+helloWorldBeanConfig.getMessageFromHelloWorldService(name));
		return "hello";
	}
}
